...
class Partie
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="id_equipe1", referencedColumnName="id", onDelete="CASCADE")
     * })
     */
    private $idEquipe1;
     ...
     * @ORM\ManyToOne(targetEntity="Equipe")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="id_equipe2", referencedColumnName="id",  onDelete="CASCADE")
     * })
     */
    private $idEquipe2;
     ...
     * @ORM\JoinColumn(name="id_tournoi", referencedColumnName="id", onDelete="CASCADE")
     */
    private $idTournoi;
