...
{
    /**
     * @Route("/searchTournoisx ", name="searchTournoisx")
     */
    public function searchTournoisx(Request $request,NormalizerInterface $Normalizer)
    {
        $repository = $this->getDoctrine()->getRepository(Tournois::class);
        $requestString=$request->get('searchValue');
        $tournois = $repository->findTournoisByNom($requestString);

//        $jsonContent = $Normalizer->normalize($tournois, 'json',['groups'=>'
//        tournois']);
//        $retour=json_encode($jsonContent);
        return $this->render('tournois/ajax.html.twig', [
            "tournois"=>$tournois,

        ]);
    }
    /**
     * @Route("/", name="app_tournois_index", methods={"GET", "POST"})
     */
