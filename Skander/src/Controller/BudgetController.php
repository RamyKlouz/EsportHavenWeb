...
class BudgetController extends AbstractController
{
    ...
    /**
     * @Route("/{idBudget}", name="app_budget_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idBudget}/edit", name="app_budget_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idBudget}", name="app_budget_delete", methods={"POST"})
     */
