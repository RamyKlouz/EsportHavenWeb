 ...
 * Partie
 *
 * @ORM\Table(name="partie", indexes={@ORM\Index(name="fk_eq2", columns={"id_equipe2"}), @ORM\Index(name="fk_tournois", columns={"id_tournoi"}), @ORM\Index(name="fk_equipe1", columns={"id_equipe1"})})
 * @ORM\Entity
 */
class Partie
{
