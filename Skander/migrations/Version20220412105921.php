 ...
 */
final class Version20220412105921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sponsors CHANGE sponsor nom_Sponsor VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commandeproduit CHANGE orderID orderID INT NOT NULL, CHANGE productID productID INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE partie CHANGE id_equipe2 id_equipe2 INT NOT NULL, CHANGE id_equipe1 id_equipe1 INT NOT NULL, CHANGE id_tournoi id_tournoi INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE reponse_reclam CHANGE id_rec id_rec INT NOT NULL, CHANGE id id INT NOT NULL');
        $this->addSql('ALTER TABLE sponsors CHANGE nom_sponsor Sponsor VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`');
